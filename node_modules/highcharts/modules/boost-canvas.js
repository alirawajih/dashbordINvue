...
I[1]/=255;I[2]/=255}m.inverted&&(oa=b.chart.plotHeight);b.closestPointRangePx=Number.MAX_VALUE;var Q=b=>{b&&(a.colorData.push(b[0]),a.colorData.push(b[1]),a.colorData.push(b[2]),a.colorData.push(b[3]))},R=(b,n,f,l=1,sa)=>{Q(sa);1===ea||t.useGPUTranslations&&!a.skipTranslation||(b*=ea,n*=ea,l*=ea);t.usePreallocated&&e?(e.push(b,n,f?1:0,l),qa+=4):(c.push(b),c.push(n),c.push(f?ea:0),c.push(l))},xa=()=>{a.segments.length&&(a.segments[a.segments.length-1].to=c.length||qa)};ha=()=>{a.segments.length&&a.segments[a.segments.length-
1].from===(c.length||qa)||(xa(),a.segments.push({from:c.length||qa}))};var ya=(b,a,n,f,l)=>{Q(l);R(b+n,a);Q(l);R(b,a);Q(l);R(b,a+f);Q(l);R(b,a+f);Q(l);R(b+n,a+f);Q(l);R(b+n,a)};ha();if(v&&0<v.length)a.skipTranslation=!0,a.drawMode="TRIANGLES",v[0].node&&v[0].node.levelDynamic&&v.sort((b,a)=>{if(b.node){if(b.node.levelDynamic>a.node.levelDynamic)return 1;if(b.node.levelDynamic<a.node.levelDynamic)return-1}return 0}),v.forEach(a=>{var n=a.plotY;if("undefined"!==typeof n&&!isNaN(n)&&null!==a.y&&a.shapeArgs){let {x:f=
0,y:l=0,width:c=0,height:t=0}=a.shapeArgs;n=m.styledMode?a.series.colorAttribs(a):n=a.series.pointAttribs(a);a=n["stroke-width"]||0;C=A(n.fill).rgba;C[0]/=255;C[1]/=255;C[2]/=255;b.is("treemap")&&(a=a||1,X=A(n.stroke).rgba,X[0]/=255,X[1]/=255,X[2]/=255,ya(f,l,c,t,X),a/=2);b.is("heatmap")&&m.inverted&&(f=E.len-f,l=y.len-l,c=-c,t=-t);ya(f+a,l+a,c-2*a,t-2*a,C)}});else{for(;G<K.length-1;){v=K[++G];if("undefined"===typeof v)continue;if(n)break;const c=V&&V[G];!F&&ma(c,!0)&&c.color&&(C=A(c.color).rgba,
...
b.chartHeight*Z;else return!1;const m=this.height,r=this.width;if(!(e&&q&&r&&m))return!1;g.debug.timeRendering&&console.time("gl rendering");e.canvas.width=r;e.canvas.height=m;q.bind();e.viewport(0,0,r,m);q.setPMatrix(P.orthoMatrix(r,m));1<g.lineWidth&&!d.isMS&&e.lineWidth(g.lineWidth);T&&(T.build(this.data,"aVertexPosition",4),T.bind());q.setInverted(b.inverted);this.series.forEach((f,d)=>{const k=f.series.options;var m=k.marker,r="undefined"!==typeof k.lineWidth?k.lineWidth:1,t=k.threshold;const V=
x(t),p=f.series.yAxis.getThreshold(t);t=M(k.marker?k.marker.enabled:null,f.series.xAxis.isRadial?!0:null,f.series.closestPointRangePx>2*((k.marker?k.marker.radius:10)||10));m=this.textureHandles[m&&m.symbol||f.series.symbol]||this.textureHandles.circle;if(0!==f.segments.length&&f.segments[0].from!==f.segments[0].to&&(m.isReady&&(e.bindTexture(e.TEXTURE_2D,m.handle),q.setTexture(m.handle)),b.styledMode?m=f.series.markerGroup&&f.series.markerGroup.getStyle("fill"):(m="POINTS"===f.drawMode&&f.series.pointAttribs&&
f.series.pointAttribs().fill||f.series.color,k.colorByPoint&&(m=f.series.chart.options.colors[d])),f.series.fillOpacity&&k.fillOpacity&&(m=(new a(m)).setOpacity(M(k.fillOpacity,1)).get()),m=A(m).rgba,g.useAlpha||(m[3]=1),"LINES"===f.drawMode&&g.useAlpha&&1>m[3]&&(m[3]/=10),"add"===k.boostBlending?(e.blendFunc(e.SRC_ALPHA,e.ONE),e.blendEquation(e.FUNC_ADD)):"mult"===k.boostBlending||"multiply"===k.boostBlending?e.blendFunc(e.DST_COLOR,e.ZERO):"darken"===k.boostBlending?(e.blendFunc(e.ONE,e.ONE),e.blendEquation(e.FUNC_MIN)):
e.blendFuncSeparate(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA),q.reset(),0<f.colorData.length?(q.setUniform("hasColor",1),d=new c(e,q),d.build(Array(f.segments[0].from).concat(f.colorData),"aColor",4),d.bind()):(q.setUniform("hasColor",0),e.disableVertexAttribArray(e.getAttribLocation(q.getProgram(),"aColor"))),q.setColor(m),this.setXAxis(f.series.xAxis),this.setYAxis(f.series.yAxis),this.setThreshold(V,p),"POINTS"===f.drawMode&&q.setPointSize(2*M(k.marker&&k.marker.radius,.5)*
...
d.plotY=b.plotY;d.index=b.i;d.percentage=b.percentage;d.isInside=a.isPointInside(d);return d}function t(){function a(a,b){const f="undefined"===typeof c.index;let m;let h,n=!1,r=!0;if("undefined"===typeof a)return!0;if(!f){if(q){m=a[0];var l=a[1]}else m=a,l=k[b];aa?(q&&(l=a.slice(1,3)),n=l[0],l=l[1]):x&&(m=a.x,l=a.stackY,n=l-a.y,h=a.percentage);N||(r=(l||0)>=V&&l<=Z);if(null!==l&&m>=g&&m<=u&&r)if(a=d.toPixels(m,!0),v){if("undefined"===typeof H||a===S){aa||(n=l);if("undefined"===typeof J||l>I)I=l,
J=b;if("undefined"===typeof H||n<O)O=n,H=b}C&&a===S||("undefined"!==typeof H&&(l=e.toPixels(I,!0),B=e.toPixels(O,!0),Q(a,l,J,h),B!==l&&Q(a,B,H,h)),H=J=void 0,S=a)}else l=Math.ceil(e.toPixels(l,!0)),Q(a,l,b,h)}return!f}var b=this.options||{};const c=this.chart,d=this.xAxis,e=this.yAxis,m=b.xData||this.processedXData,k=b.yData||this.processedYData,r=b.data;var h=d.getExtremes();const g=h.min,u=h.max;h=e.getExtremes();const V=h.min,Z=h.max,t={},v=!!this.sampling,w=b.enableMouseTracking;h=b.threshold;
const aa=this.pointArrayMap&&"low,high"===this.pointArrayMap.join(","),x=!!b.stacking,y=this.cropStart||0,N=this.requireSorting,q=!m,C="x"===b.findNearestPointBy,E=this.xData||this.options.xData||this.processedXData||!1;b=!1;let S,B=e.getThreshold(h),O,I,H,J;b=A(c,this);c.boosted=!0;if(this.visible){(this.points||this.graph)&&ma(this);f(c)?(this.markerGroup&&this.markerGroup!==c.boost.markerGroup&&this.markerGroup.destroy(),this.markerGroup=c.boost.markerGroup,this.boost&&this.boost.target&&(this.renderTarget=
this.boost.target=this.boost.target.destroy())):(c.boost&&this.markerGroup===c.boost.markerGroup&&(this.markerGroup=void 0),this.markerGroup=this.plotGroup("markerGroup","markers",!0,1,c.seriesGroup));var M=this.points=[],Q=(a,b,f,m)=>{const l=E?E[y+f]:!1,n=a=>{c.inverted&&(a=d.len-a,b=e.len-b);M.push({destroy:va,x:l,clientX:a,plotX:a,plotY:b,i:y+f,percentage:m})};a=Math.ceil(a);K=C?a:a+","+b;w&&(t[K]?l===E[E.length-1]&&(M.length--,n(a)):(t[K]=!0,n(a)))};this.buildKDTree=va;b&&(F(b,this),b.pushSeries(this),
P(this));var R=b.settings;b=()=>{za(this,"renderedCanvas");delete this.buildKDTree;this.buildKDTree();R.debug.timeKDTree&&console.timeEnd("kd tree building")};c.renderer.forExport||(R.debug.timeKDTree&&console.time("kd tree building"),p(x?this.data:m||r,a,b))}}function ua(a){let b=!0;this.chart.options&&this.chart.options.boost&&(b="undefined"===typeof this.chart.options.boost.enabled?!0:this.chart.options.boost.enabled);if(!b||!this.boosted)return a.call(this);this.chart.boosted=!0;if(a=A(this.chart,
this))F(a,this),a.pushSeries(this);P(this)}function q(b,c,d){function f(b){const c=this.options.stacking&&("translate"===d||"generatePoints"===d);this.boosted&&!c&&e(this.chart)&&"heatmap"!==this.type&&"treemap"!==this.type&&a[this.type]&&0!==this.options.boostThreshold?"render"===d&&this.renderCanvas&&this.renderCanvas():b.call(this)}U(b,d,f);"translate"===d&&["column","arearange","columnrange","heatmap","treemap"].forEach(function(a){c[a]&&U(c[a].prototype,d,f)})}function T(a){return this.boosted&&
B(this)?{}:a.apply(this,[].slice.call(arguments,1))}function Z(b){var c=this.options.data;const d=a=>this.forceCrop?!1:f(this.chart)||(a?a.length:0)>=(this.options.boostThreshold||Number.MAX_VALUE);e(this.chart)&&a[this.type]?(d(c)&&"heatmap"!==this.type&&"treemap"!==this.type&&!this.options.stacking&&B(this,!0)||(b.apply(this,[].slice.call(arguments,1)),c=this.processedXData),(this.boosted=d(c))?(this.options.data&&this.options.data.length&&(c=this.getFirstValidPoint(this.options.data),W(c)||Aa(c)||
aa(12,!1,this.chart)),ia(this)):M(this)):b.apply(this,[].slice.call(arguments,1))}function m(a){const b=a.apply(this,[].slice.call(arguments,1));return this.boost&&b?this.boost.getPoint(b):b}const {getBoostClipRect:r,isChartSeriesBoosting:f}=g,{getOptions:V}=w,{doc:k,noop:va,win:u}=y,{addEvent:S,error:aa,extend:N,fireEvent:za,isArray:Aa,isNumber:W,pick:E,wrap:U}=c,v=[];let K,ra;return{compose:function(a,b,e){if(c.pushUnique(v,a)){S(a,"destroy",ja);S(a,"hide",J);const c=a.prototype;e&&(c.renderCanvas=
t);U(c,"getExtremes",T);U(c,"processData",Z);U(c,"searchPoint",m);["translate","generatePoints","drawTracker","drawPoints","render"].forEach(a=>q(c,b,a))}if(c.pushUnique(v,V)){const a=V().plotOptions;d.forEach(c=>{const d=a[c];d&&(d.boostThreshold=5E3,d.boostData=[],b[c].prototype.fillOpacity=!0)})}if(e){const {area:a,areaspline:d,bubble:f,column:m,heatmap:k,scatter:h,treemap:r}=b;a&&c.pushUnique(v,a)&&N(a.prototype,{fill:!0,fillOpacity:!0,sampling:!0});d&&c.pushUnique(v,d)&&N(d.prototype,{fill:!0,
fillOpacity:!0,sampling:!0});f&&c.pushUnique(v,f)&&(e=f.prototype,delete e.buildKDTree,U(e,"markerAttribs",function(a){return this.boosted?!1:a.apply(this,[].slice.call(arguments,1))}));m&&c.pushUnique(v,m)&&N(m.prototype,{fill:!0,sampling:!0});h&&c.pushUnique(v,h)&&(h.prototype.fill=!0);[k,r].forEach(a=>{a&&c.pushUnique(v,a)&&U(a.prototype,"drawPoints",ua)})}return a},destroyGraphics:ma,eachAsync:p,getPoint:b}});x(a,"Extensions/BoostCanvas.js",[a["Extensions/Boost/BoostChart.js"],a["Extensions/Boost/BoostSeries.js"],
...
function(b,d){let e,g=!1,m=!1,h=!1,r=!1,n="undefined"===typeof k.index,t=!0;if(!n){if(C){var q=b[0];var p=b[1];H[d+1]&&(h=H[d+1][0]);H[d-1]&&(r=H[d-1][0])}else q=b,p=ia[d],H[d+1]&&(h=H[d+1]),H[d-1]&&(r=H[d-1]);h&&h>=U&&h<=v&&(g=!0);r&&r>=U&&r<=v&&(m=!0);G?(C&&(p=b.slice(1,3)),e=p[0],p=p[1]):Y&&(q=b.x,p=b.stackY,e=p-b.y);b=null===p;ka||(t=p>=K&&p<=ra);if(!b&&(q>=U&&q<=v&&t||g||m))if(q=Math.round(w.toPixels(q,!0)),sa){if("undefined"===typeof ca||q===l){G||(e=p);if("undefined"===typeof O||p>pa)pa=p,
O=d;if("undefined"===typeof ca||e<la)la=e,ca=d}q!==l&&("undefined"!==typeof ca&&(p=u.toPixels(pa,!0),L=u.toPixels(la,!0),c(q,D?Math.min(p,z):p,D?Math.max(L,z):L,d),a(q,p,O),L!==p&&a(q,L,ca)),ca=O=void 0,l=q)}else p=Math.round(u.toPixels(p,!0)),c(q,p,L,d),a(q,p,d);wa=b&&!Ca;0===d%5E4&&(f.boost&&f.boost.copy?f.boost.copy():f.chart.boost&&f.chart.boost.copy&&f.chart.boost.copy())}return!n},function(){const a=k.loadingDiv,b=k.loadingShown;e();f.canvasToSVG();y&&console.timeEnd("canvas rendering");P(f,
