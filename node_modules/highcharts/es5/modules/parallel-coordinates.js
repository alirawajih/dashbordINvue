...
(c.parallelInfo.counter=Math.max(c.parallelInfo.counter,a.data.length-1))})}});l(q,"bindAxes",function(a){if(this.chart.hasParallelCoordinates){var c=this;this.chart.axes.forEach(function(a){E(c,a.series);a.isDirty=!0});c.xAxis=this.chart.xAxis[0];c.yAxis=this.chart.yAxis[0];a.preventDefault()}});l(q,"afterTranslate",function(){var a=this.chart,c=this.points,b=c&&c.length,h=Number.MAX_VALUE,f;if(this.chart.hasParallelCoordinates){for(f=0;f<b;f++){var e=c[f];if(r(e.y)){e.plotX=a.polar?a.yAxis[f].angleRad||
