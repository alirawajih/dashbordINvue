...
d.push(e);return d},[])};c.prototype.isCollapsed=function(a){var b=this.axis,c=b.options.breaks||[],d=r(a,b.max);return c.some(function(a){return a.from===d.from&&a.to===d.to})};c.prototype.toggleCollapse=function(a){return this.isCollapsed(a)?this.expand(a):this.collapse(a)};return c}();return d});F(e,"masters/modules/treegrid.src.js",[e["Core/Globals.js"],e["Core/Axis/TreeGrid/TreeGridAxis.js"]],function(e,t){t.compose(e.Axis,e.Chart,e.Series,e.Tick)})});
