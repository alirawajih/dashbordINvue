...
f){a.pushUnique(r,m)&&(b(m,"afterDrawCrosshair",h),b(m,"afterRender",g));a.pushUnique(r,f)&&(b(f,"afterGetPosition",c),m=f.prototype,m.postTranslate=w,u(m,"getLabelPosition",p))}}});g(a,"Series/Variwide/VariwidePoint.js",[a["Core/Series/SeriesRegistry.js"],a["Core/Utilities.js"]],function(a,h){var g=this&&this.__extends||function(){function a(c,b){a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,b){a.__proto__=b}||function(a,b){for(var c in b)Object.prototype.hasOwnProperty.call(b,
