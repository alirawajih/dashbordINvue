...
{};l(f,"Core/Axis/BrokenAxis.js",[f["Core/Axis/Stacking/StackItem.js"],f["Core/Utilities.js"]],function(f,h){var n=h.addEvent,l=h.find,w=h.fireEvent,z=h.isArray,m=h.isNumber,u=h.pick,v;(function(v){function A(){"undefined"!==typeof this.brokenAxis&&this.brokenAxis.setBreaks(this.options.breaks,!1)}function B(){this.brokenAxis&&this.brokenAxis.hasBreaks&&(this.options.ordinal=!1)}function C(){var c=this.brokenAxis;if(c&&c.hasBreaks){for(var b=this.tickPositions,g=this.tickPositions.info,e=[],a=0;a<
b.length;a++)c.isInAnyBreak(b[a])||e.push(b[a]);this.tickPositions=e;this.tickPositions.info=g}}function D(){this.brokenAxis||(this.brokenAxis=new x(this))}function E(){var c=this.options.connectNulls,b=this.points,g=this.xAxis,e=this.yAxis;if(this.isDirty)for(var a=b.length;a--;){var d=b[a],f=!(null===d.y&&!1===c)&&(g&&g.brokenAxis&&g.brokenAxis.isInAnyBreak(d.x,!0)||e&&e.brokenAxis&&e.brokenAxis.isInAnyBreak(d.y,!0));d.visible=f?!1:!1!==d.options.visible}}function F(){this.drawBreaks(this.xAxis,
["x"]);this.drawBreaks(this.yAxis,u(this.pointArrayMap,["y"]))}function G(c,b){var g=this,e=g.points,a,d,f,k;if(c&&c.brokenAxis&&c.brokenAxis.hasBreaks){var h=c.brokenAxis;b.forEach(function(b){a=h&&h.breakArray||[];d=c.isXAxis?c.min:u(g.options.threshold,c.min);e.forEach(function(e){k=u(e["stack"+b.toUpperCase()],e[b]);a.forEach(function(a){if(m(d)&&m(k)){f=!1;if(d<a.from&&k>a.to||d>a.from&&k<a.from)f="pointBreak";else if(d<a.from&&k>a.from&&k<a.to||d>a.from&&k>a.to&&k<a.from)f="pointInBreak";f&&
w(c,f,{point:e,brk:a})}})})})}}function H(){var c=this.currentDataGrouping,b=c&&c.gapSize;c=this.points.slice();var g=this.yAxis,e=this.options.gapSize,a=c.length-1,d;if(e&&0<a)for("value"!==this.options.gapUnit&&(e*=this.basePointRange),b&&b>e&&b>=this.basePointRange&&(e=b),d=void 0;a--;)d&&!1!==d.visible||(d=c[a+1]),b=c[a],!1!==d.visible&&!1!==b.visible&&(d.x-b.x>e&&(d=(b.x+d.x)/2,c.splice(a+1,0,{isNull:!0,x:d}),g.stacking&&this.options.stacking&&(d=g.stacking.stacks[this.stackKey][d]=new f(g,g.options.stackLabels,
!1,d,this.stack),d.total=0)),d=b);return this.getGraphPath(c)}var y=[];v.compose=function(c,b){h.pushUnique(y,c)&&(c.keepProps.push("brokenAxis"),n(c,"init",D),n(c,"afterInit",A),n(c,"afterSetTickPositions",C),n(c,"afterSetOptions",B));if(h.pushUnique(y,b)){var g=b.prototype;g.drawBreaks=G;g.gappedPath=H;n(b,"afterGeneratePoints",E);n(b,"afterRender",F)}return c};var x=function(){function c(b){this.hasBreaks=!1;this.axis=b}c.isInBreak=function(b,c){var e=b.repeat||Infinity,a=b.from,d=b.to-b.from;
