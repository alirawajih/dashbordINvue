...
c;a.toYData=d;a.translate=q}return b}})(h||(h={}));return h});l(a,"Stock/Indicators/PC/PCIndicator.js",[a["Stock/Indicators/ArrayUtilities.js"],a["Stock/Indicators/MultipleLinesComposition.js"],a["Core/Color/Palettes.js"],a["Core/Series/SeriesRegistry.js"],a["Core/Utilities.js"]],function(a,e,g,f,k){var l=this&&this.__extends||function(){function a(e,c){a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,c){a.__proto__=c}||function(a,c){for(var d in c)Object.prototype.hasOwnProperty.call(c,
d)&&(a[d]=c[d])};return a(e,c)}return function(e,c){function d(){this.constructor=e}if("function"!==typeof c&&null!==c)throw new TypeError("Class extends value "+String(c)+" is not a constructor or null");a(e,c);e.prototype=null===c?Object.create(c):(d.prototype=c.prototype,new d)}}(),h=f.seriesTypes.sma,x=k.merge;k=k.extend;var m=function(e){function f(){var a=null!==e&&e.apply(this,arguments)||this;a.data=void 0;a.options=void 0;a.points=void 0;return a}l(f,e);f.prototype.getValues=function(c,d){d=
d.period;var e=c.xData,f=(c=c.yData)?c.length:0,g=[],h=[],l=[],b;if(!(f<d)){for(b=d;b<=f;b++){var p=e[b-1];var n=c.slice(b-d,b);var k=a.getArrayExtremes(n,2,1);n=k[1];var m=k[0];k=(n+m)/2;g.push([p,n,k,m]);h.push(p);l.push([n,k,m])}return{values:g,xData:h,yData:l}}};f.defaultOptions=x(h.defaultOptions,{params:{index:void 0,period:20},lineWidth:1,topLine:{styles:{lineColor:g.colors[2],lineWidth:1}},bottomLine:{styles:{lineColor:g.colors[8],lineWidth:1}},dataGrouping:{approximation:"averages"}});return f}(h);
k(m.prototype,{areaLinesNames:["top","bottom"],nameBase:"Price Channel",nameComponents:["period"],linesApiNames:["topLine","bottomLine"],pointArrayMap:["top","middle","bottom"],pointValKey:"middle"});e.compose(m);f.registerSeriesType("pc",m);"";return m});l(a,"masters/indicators/price-channel.src.js",[],function(){})});
