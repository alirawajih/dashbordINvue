...
e.plotY;var x=u.plotX-a.plotX;u=u.plotY-a.plotY;var f=e.plotX-a.plotX,p=e.plotY-a.plotY;a=(-b*f+d*p)/(-x*b+d*u);x=(x*p-u*f)/(-x*b+d*u);if(0<=a&&1>=a&&0<=x&&1>=x)return{plotX:e.plotX+x*d,plotY:e.plotY+x*b}}}function E(e){var b=e.indicator;b.points=e.points;b.nextPoints=e.nextPoints;b.color=e.color;b.options=B(e.options.senkouSpan.styles,e.gap);b.graph=e.graph;b.fillGraph=!0;w.seriesTypes.sma.prototype.drawGraph.call(b)}var I=this&&this.__extends||function(){function e(b,a){e=Object.setPrototypeOf||
{__proto__:[]}instanceof Array&&function(a,d){a.__proto__=d}||function(a,d){for(var b in d)Object.prototype.hasOwnProperty.call(d,b)&&(a[b]=d[b])};return e(b,a)}return function(b,a){function u(){this.constructor=b}if("function"!==typeof a&&null!==a)throw new TypeError("Class extends value "+String(a)+" is not a constructor or null");e(b,a);b.prototype=null===a?Object.create(a):(u.prototype=a.prototype,new u)}}(),C=m.parse,F=w.seriesTypes.sma,J=k.defined;m=k.extend;var K=k.isArray,L=k.isNumber,M=k.getClosestDistance,
B=k.merge,N=k.objectEach;k=function(e){function b(){var a=null!==e&&e.apply(this,arguments)||this;a.data=[];a.options={};a.points=[];a.graphCollection=[];return a}I(b,e);b.prototype.init=function(){e.prototype.init.apply(this,arguments);this.options=B({tenkanLine:{styles:{lineColor:this.color}},kijunLine:{styles:{lineColor:this.color}},chikouLine:{styles:{lineColor:this.color}},senkouSpanA:{styles:{lineColor:this.color,fill:C(this.color).setOpacity(.5).get()}},senkouSpanB:{styles:{lineColor:this.color,
