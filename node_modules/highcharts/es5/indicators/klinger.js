/*
 Highcharts Stock JS v11.1.0 (2023-09-05)
...
a["Core/Series/SeriesRegistry.js"],a["Core/Utilities.js"]],function(a,h,g){var k=this&&this.__extends||function(){function a(e,b){a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(b,a){b.__proto__=a}||function(b,a){for(var d in a)Object.prototype.hasOwnProperty.call(a,d)&&(b[d]=a[d])};return a(e,b)}return function(e,b){function d(){this.constructor=e}if("function"!==typeof b&&null!==b)throw new TypeError("Class extends value "+String(b)+" is not a constructor or null");a(e,b);e.prototype=
null===b?Object.create(b):(d.prototype=b.prototype,new d)}}(),m=h.seriesTypes,p=m.ema,l=m.sma,n=g.correctFloat,x=g.error;m=g.extend;var q=g.isArray,y=g.merge;g=function(a){function e(){var b=null!==a&&a.apply(this,arguments)||this;b.data=void 0;b.points=void 0;b.options=void 0;b.volumeSeries=void 0;return b}k(e,a);e.prototype.calculateTrend=function(b,a){return b[a][1]+b[a][2]+b[a][3]>b[a-1][1]+b[a-1][2]+b[a-1][3]?1:-1};e.prototype.isValidData=function(b){var a=this.chart,f=this.options,e=this.linkedParent;
b=q(b)&&4===b.length;(a=this.volumeSeries||(this.volumeSeries=a.get(f.params.volumeSeriesID)))||x("Series "+f.params.volumeSeriesID+" not found! Check `volumeSeriesID`.",!0,e.chart);return!(![e,a].every(function(b){return b&&b.xData&&b.xData.length>=f.params.slowAvgPeriod})||!b)};e.prototype.getCM=function(b,a,f,e,g){return n(a+(f===e?b:g))};e.prototype.getDM=function(b,a){return n(b-a)};e.prototype.getVolumeForce=function(b){var a=[],f=1;var e=0;var g=b[0][1]-b[0][2];var c=0;for(f;f<b.length;f++){var h=
this.calculateTrend(b,f);var k=this.getDM(b[f][1],b[f][2]);e=this.getCM(e,k,h,c,g);c=this.volumeSeries.yData[f]*h*Math.abs(2*(k/e-1))*100;a.push([c]);c=h;g=k}return a};e.prototype.getEMA=function(b,a,f,e,g,c,h){return p.prototype.calculateEma(h||[],b,"undefined"===typeof c?1:c,e,a,"undefined"===typeof g?-1:g,f)};e.prototype.getSMA=function(b,a,f){return p.prototype.accumulatePeriodPoints(b,a,f)/b};e.prototype.getValues=function(a,d){var b=[],e=a.xData;a=a.yData;var g=[],c=[],h=[],k,l=0,m=0,p=void 0,
r=void 0,q=null;if(this.isValidData(a[0])){var w=this.getVolumeForce(a),x=this.getSMA(d.fastAvgPeriod,0,w),u=this.getSMA(d.slowAvgPeriod,0,w),y=2/(d.fastAvgPeriod+1),z=2/(d.slowAvgPeriod+1);for(l;l<a.length;l++)l>=d.fastAvgPeriod&&(p=m=this.getEMA(w,p,x,y,0,l,e)[1]),l>=d.slowAvgPeriod&&(r=k=this.getEMA(w,r,u,z,0,l,e)[1],k=n(m-k),h.push(k),h.length>=d.signalPeriod&&(q=h.slice(-d.signalPeriod).reduce(function(a,b){return a+b})/d.signalPeriod),b.push([e[l],k,q]),g.push(e[l]),c.push([k,q]));return{values:b,
