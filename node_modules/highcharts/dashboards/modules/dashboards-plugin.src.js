/**
 * @license Highcharts Dashboards v (2023-09-05)
 *
            ...
            constructDataGrid() {
                if (DataGridComponent.DataGridConstructor) {
                    const columnOptions = this.connector ?
                        ...
                        {};
                    this.dataGrid = new DataGridComponent.DataGridConstructor(this.contentElement, Object.assign(Object.assign({}, this.options.dataGridOptions), { dataTable: this.filterColumns(), columns: columnOptions }));
