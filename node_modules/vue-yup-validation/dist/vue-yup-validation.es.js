...
const _sfc_main = {
  ...
  methods: {
    validate(field) {
      return this.schema.validateAt(field, this.values).then(() => {
        this.errors[field] = "";
      }).catch((err) => {
    ...
    validateForm() {
      this.errors = {};
      return this.schema.validate(this.values, { abortEarly: false }).then(() => {
        return true;
      }).catch((err) => {
    ...
    values: {
      handler() {
        ...
        for (const propriety of Object.keys(this.values)) {
          if (!lodash.exports.isEqual(this.oldValues[propriety], this.values[propriety])) {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("form", {
    ...
    renderSlot(_ctx.$slots, "default", { errors: $data.errors })
  ], 32);
}
var VueYupValidation = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export { VueYupValidation as default };
